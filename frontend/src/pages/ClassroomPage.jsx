      ...
      try {
        ...
        try {
          ...
          if (submission.submitted) {
            ...
            setCode(
              submission.submission.code || questionData.template_code || "",
            );
      ...
      setOutput([
        {
          ...
          text: result.feedback
            ? "Submitted with feedback — review the LLM note."
            : "Solution submitted successfully!",
        },
        {
          type: "info",
          text: `Submitted at ${new Date().toLocaleTimeString()}`,
        },
      ]);
    } catch (error) {
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* ML Classification */}
            {existingSubmission?.error_category && (
              <div
                style={{
                  background:
              ...
              >
                ...
                >
                  ...
                  >
                    {Math.round(existingSubmission.error_confidence * 100)}%
                    confidence
                  </div>
                </div>
              </div>
          ...
          >
            ...
            >
              ...
              {submitted && existingSubmission && (
                ...
                >
                  Last submitted{" "}
                  {new Date(existingSubmission.UpdatedAt).toLocaleTimeString()}
                </span>
              )}
            </div>
            ...
            >
              ...
              >
                {running ? (
                  <>
                    <LoadingSpinner size={14} color="#fff" /> Submitting…
                  </>
                ) : submitted ? (
                  "↺ Re-submit"
                ) : (
