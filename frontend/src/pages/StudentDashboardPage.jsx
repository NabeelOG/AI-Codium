  ...
  const handleJoin = async (code) => {
    ...
    try {
      ...
      if (error.response?.status === 404) {
        ...
        errorMessage =
          error.response.data?.error || "Cannot join this classroom.";
        ...
        {classrooms.length === 0 ? (
          ...
          >
            ...
            <div style={{ fontSize: "0.9rem", marginBottom: "1.25rem" }}>
              Ask your teacher for an invite code and join your first classroom.
            </div>
            <button
              className="btn btn-primary"
              onClick={() => setShowJoin(true)}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          className={`badge badge-${classroom.archived ? "archived" : "active"}`}
        >
      ...
      {classroom.description && (
        ...
        >
          {classroom.description.slice(0, 80)}
      ...
      >
        ...
        <button
          ...
          style={{ fontSize: "0.8125rem", padding: "0.125rem 0.25rem" }}
        >
          Open →
        </button>
      </div>
