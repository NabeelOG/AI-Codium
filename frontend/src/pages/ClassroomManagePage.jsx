...
export default function ClassroomManagePage() {
  ...
  const copyLink = () => {
    navigator.clipboard
      .writeText(`${window.location.origin}/join/${classroom?.invite_code}`)
      .catch(() => {});
    setCopied(true);
  ...
  const handleDeleteQuestion = async (qid) => {
    ...
    try {
      ...
      const updatedQuestions = await getClassroomQuestions(id);
      ...
      <main style={{ flex: 1, overflowY: "auto", padding: "2rem 2rem 3rem" }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
            ...
            <button
              className="btn btn-primary"
              onClick={() => navigate(`/teacher/classroom/${id}/question/new`)}
              style={{ fontSize: "0.875rem" }}
            >
              + Add Question
            </button>
        ...
        >
          {[
            ...
            {
              label: "Status",
              value: classroom.archived ? "Archived" : "Active",
            },
          ].map(({ label, value }) => (
            ...
            {questions.length === 0 ? (
              ...
              >
                ...
                <div style={{ fontSize: "0.875rem", marginBottom: "1rem" }}>
                  Add your first coding question for students.
                </div>
                <button
                  className="btn btn-primary"
                  onClick={() =>
                    navigate(`/teacher/classroom/${id}/question/new`)
                  }
                >
                  + Add Question
                </button>
